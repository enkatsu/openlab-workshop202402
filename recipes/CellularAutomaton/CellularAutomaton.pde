...
/**
 * ルール110セル・オートマトン
 * https://ja.wikipedia.org/wiki/%E3%82%BB%E3%83%AB%E3%83%BB%E3%82%AA%E3%83%BC%E3%83%88%E3%83%9E%E3%83%88%E3%83%B3#%E3%83%AB%E3%83%BC%E3%83%AB110%E3%82%BB%E3%83%AB%E3%83%BB%E3%82%AA%E3%83%BC%E3%83%88%E3%83%9E%E3%83%88%E3%83%B3
 */
boolean[] rule110(boolean[] now) {
  boolean[] next = new boolean[now.length];
  for (int i = 0; i < now.length; i++) {
    boolean l = i == 0 ? false : now[i - 1];
    boolean c = now[i];
    boolean r = i == now.length - 1 ? false : now[i + 1];
    if (l && c && r) {
      next[i] = false;
    } else if (l  &&  c && !r) {
      next[i] = true;
